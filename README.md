...
> **Note:** Speculative Rules API supports same-site cross origin Prerendering with [opt-in header](https://docs.google.com/document/d/1WsDYA8NMCSwsK8dXCKdajdAd3ZcQUu9w1eoe0hEB_nU/).
